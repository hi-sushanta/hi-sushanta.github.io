...
<div class="social-icon" style="margin-left:5x; margin-right:5px; margin-top:50px; margin-bottom:50px;  display: flex; align-items: center;"> 
    <h3 style="margin-left:20%; margin-right:15px; margin-top:0px;"><strong>Follow Me : </strong> </h3>
