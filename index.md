...
<div class="social-icon" style="margin-left:40%; margin-right:10px; margin-top:50px; margin-bottom:3px;  display: flex; align-items: center; background:#FFF;  border-radius:16px; width: fit-content;"> 
