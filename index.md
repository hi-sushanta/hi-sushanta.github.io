...
<div class="social-icon" style="margin-right:10px; margin-top:50px; margin-bottom:3px;  display: flex; align-items: center; background:#FFF;  border-radius:16px; width: fit-content;"> 
  ...
  <iframe src="https://embeds.beehiiv.com/1b74346f-b64b-4871-b8f4-5b2c34a63ac1?slim=true" data-test-id="beehiiv-embed" height="52" frameborder="0" scrolling="no" style="margin: 0; margin-left:20px; margin-right:20px; border-radius: 0px !important; background-color: transparent;"></iframe>
</div>
