...
<div class="social-icon" style="margin-left:40px; margin-right:40px; margin-top:50px; margin-bottom:50px;  display: flex; align-items: center; background:#F8F4EC; padding-left:40px; padding-right:40px; border-radius:16px;"> 
    <h3 style="margin-left:10%; margin-right:15px; margin-top:0px;"><strong>Follow Me  👉 </strong> </h3>
